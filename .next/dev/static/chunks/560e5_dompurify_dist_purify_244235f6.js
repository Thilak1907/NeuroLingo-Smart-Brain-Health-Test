...
"[project]/Desktop/Projects/Neuro-lingo/neurolingo-brain-health-test/node_modules/dompurify/dist/purify.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
   ...
   */ var _createTrustedTypesPolicy = function _createTrustedTypesPolicy(trustedTypes, document) {
     ...
     * of importing it into a new Document and returning a sanitized copy */ var IN_PLACE = false;
        ...
        var isRegexOrFunction = function isRegexOrFunction(testValue) {
            return _instanceof._(testValue, RegExp) || _instanceof._(testValue, Function);
        };
        /**
     * _parseConfig
     *
     ...
     */ var _isClobbered = function _isClobbered(elm) {
            return _instanceof._(elm, HTMLFormElement) && (typeof elm.nodeName !== 'string' || typeof elm.textContent !== 'string' || typeof elm.removeChild !== 'function' || !_instanceof._(elm.attributes, NamedNodeMap) || typeof elm.removeAttribute !== 'function' || typeof elm.setAttribute !== 'function' || typeof elm.namespaceURI !== 'string' || typeof elm.insertBefore !== 'function' || typeof elm.hasChildNodes !== 'function');
        };
        /**
     * _isNode
     *
     ...
     */ var _isNode = function _isNode(object) {
            return _typeof(Node) === 'object' ? _instanceof._(object, Node) : object && _typeof(object) === 'object' && typeof object.nodeType === 'number' && typeof object.nodeName === 'string';
        };
        /**
     * _executeHook
     ...
     */ var _sanitizeElements = function _sanitizeElements(currentNode) {
            ...
            /* Remove element if anything forbids its presence */ if (!ALLOWED_TAGS[tagName] || FORBID_TAGS[tagName]) {
                /* Check if we have a custom element to handle */ if (!FORBID_TAGS[tagName] && _basicCustomElementTest(tagName)) {
                    if (_instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, RegExp) && regExpTest(CUSTOM_ELEMENT_HANDLING.tagNameCheck, tagName)) return false;
                    if (_instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, Function) && CUSTOM_ELEMENT_HANDLING.tagNameCheck(tagName)) return false;
                }
            ...
            /* Check whether element has a valid namespace */ if (_instanceof._(currentNode, Element) && !_checkValidNamespace(currentNode)) {
                _forceRemove(currentNode);
                return true;
            }
     ...
     */ // eslint-disable-next-line complexity
        var _isValidAttribute = function _isValidAttribute(lcTag, lcName, value) {
          ...
          We don't need to check the value; it's always URI safe. */ if (ALLOW_DATA_ATTR && !FORBID_ATTR[lcName] && regExpTest(DATA_ATTR$1, lcName)) ;
                ...
                _basicCustomElementTest(lcTag) && (_instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, RegExp) && regExpTest(CUSTOM_ELEMENT_HANDLING.tagNameCheck, lcTag) || _instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, Function) && CUSTOM_ELEMENT_HANDLING.tagNameCheck(lcTag)) && (_instanceof._(CUSTOM_ELEMENT_HANDLING.attributeNameCheck, RegExp) && regExpTest(CUSTOM_ELEMENT_HANDLING.attributeNameCheck, lcName) || _instanceof._(CUSTOM_ELEMENT_HANDLING.attributeNameCheck, Function) && CUSTOM_ELEMENT_HANDLING.attributeNameCheck(lcName)) || // Alternative, second condition checks if it's an `is`-attribute, AND
                // the value passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
                lcName === 'is' && CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (_instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, RegExp) && regExpTest(CUSTOM_ELEMENT_HANDLING.tagNameCheck, value) || _instanceof._(CUSTOM_ELEMENT_HANDLING.tagNameCheck, Function) && CUSTOM_ELEMENT_HANDLING.tagNameCheck(value))) ;
                else {
                    return false;
                }
     ...
     */ var _sanitizeShadowDOM = function _sanitizeShadowDOM(fragment) {
            ...
            while(shadowNode = shadowIterator.nextNode()){
                ...
                /* Deep shadow DOM detected */ if (_instanceof._(shadowNode.content, DocumentFragment)) {
     ...
     */ // eslint-disable-next-line complexity
        ...
        the user has requested a DOM object rather than a string */ IS_EMPTY_INPUT = !dirty;
            ...
            } else if (_instanceof._(dirty, Node)) {
           ...
           elements being stripped by the parser */ body = _initDocument('<!---->');
            ...
            /* Now start iterating over the created document */ while(currentNode = nodeIterator.nextNode()){
                ...
                /* Shadow DOM detected, sanitize it */ if (_instanceof._(currentNode.content, DocumentFragment)) {
...
//# sourceMappingURL=560e5_dompurify_dist_purify_244235f6.js.map